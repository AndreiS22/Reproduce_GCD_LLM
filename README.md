...
## Environment
* Requirements: Numpy, pyTorch, python 3.12.9.
* OS: Tested on Windows
* A NVIDIA/CUDA GPU is recommended of you intend to train models: if you do not have one it will be slower to train
